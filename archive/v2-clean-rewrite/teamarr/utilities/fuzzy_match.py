...
MASCOT_WORDS = {
    ...
    # Animals
    "eagles", "owls", "lions", "tigers", "bears", "wolves", "hawks", "falcons",
    ...
    "mavericks", "rockets", "bruins", "canadiens", "red wings", "blackhawks",
    ...
    "flames", "oilers", "canucks", "sharks", "ducks", "coyotes", # College
    ...
    "nittany lions", "orange", "mountaineers", "red raiders",
    "horned frogs", "mustangs", "golden eagles", "blue devils", "demon deacons",
    "fighting irish", "trojans", "beavers", "sun devils", "buffaloes", "utes",
    "rebels", "aztecs", "rainbow warriors",
    "retrievers", "black knights", "musketeers", "beacons", "lancers",
    "governors", "skyhawks", "tornados", "runnin' bulldogs",
    # Soccer
