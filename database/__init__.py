...
# =============================================================================
# These functions provide compatibility with V2's provider abstraction layer

# Alias for V2 compatibility - get_db is the same as db_connection
get_db = db_connection

# Import league mapping functions from leagues module
from database.leagues import (
    LeagueMapping,
    get_league_mapping,
...
__all__ = [
    'get_connection', 'db_connection', 'get_db',
    'LeagueMapping', 'get_league_mapping', 'get_leagues_for_provider', 'provider_supports_league',
]
