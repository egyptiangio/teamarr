...
Provides pattern generation and matching utilities.
"""
...
# When "Detroit Lions" doesn't match, we try "Detroit"
MASCOT_WORDS = {
    # Generic
    "team", "club", "fc", "sc", "cf", "united", "city",
    # NFL
    "eagles", "lions", "tigers", "bears", "wolves", "hawks", "falcons",
    "panthers", "jaguars", "bengals", "colts", "broncos", "chargers", "raiders",
    "ravens", "cardinals", "seahawks", "dolphins", "bills", "jets", "giants",
    "patriots", "steelers", "browns", "packers", "vikings", "saints", "buccaneers",
    "cowboys", "commanders", "49ers", "rams", "chiefs", "texans", "titans",
    # NBA
    "cavaliers", "celtics", "bulls", "pistons", "pacers", "heat", "magic",
    "hornets", "wizards", "knicks", "nets", "76ers", "sixers", "raptors",
    "bucks", "timberwolves", "thunder", "blazers", "warriors", "kings", "lakers",
    "clippers", "suns", "nuggets", "jazz", "grizzlies", "pelicans", "spurs",
    "mavericks", "rockets",
    # NHL
    "bruins", "canadiens", "red wings", "blackhawks",
    "blues", "avalanche", "stars", "wild", "predators", "hurricanes", "lightning",
    "rangers", "islanders", "devils", "flyers", "penguins", "capitals",
    "blue jackets", "senators", "maple leafs", "sabres", "kraken", "golden knights",
    "flames", "oilers", "canucks", "sharks", "ducks", "coyotes",
    # College
    "bulldogs", "wildcats", "huskies", "cougars", "badgers", "gophers",
    "wolverines", "buckeyes", "spartans", "hoosiers", "boilermakers", "hawkeyes",
    "cornhuskers", "cyclones", "jayhawks", "sooners", "longhorns", "aggies",
    "razorbacks", "volunteers", "commodores", "crimson tide", "gators",
    "seminoles", "yellow jackets", "tar heels", "wolfpack", "hokies", "terrapins",
    "nittany lions", "orange", "mountaineers", "red raiders", "owls",
    "horned frogs", "mustanns", "golden eagles", "blue devils", "demon deacons",
    "fighting irish", "trojans", "beavers", "sun devils", "buffaloes", "utes",
    "rebels", "aztecs", "rainbow warriors", "retrievers", "black knights",
    "musketeers", "beacons", "lancers", "governors", "skyhawks", "tornados",
    # Soccer
    "rovers", "wanderers", "albion", "athletic", "sporting", "real", "dynamo",
    "racing", "deportivo", "atletico", "inter", "ac", "as", "ss", "us",
    # Misc
...
class FuzzyMatcher:
    ...
    def generate_team_patterns(self, team: Team) -> list[str]:
        ...
        1. Full name: "Florida Atlantic Owls"
        2. Name without mascot: "Florida Atlantic"
        3. Short name: "FAU" or "Fla Atlantic"
        4. Abbreviation: "FAU"
        """
        patterns = []
        seen = set()
